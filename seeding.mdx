---
title: "Bootstrap the admin user in the Development environment"
sidebarTitle: "Seeding"
description: "AdminUserSeeder runs at startup in Development, checks for an existing admin, and creates one from Seed:AdminEmail and Seed:AdminPassword if absent."
---
