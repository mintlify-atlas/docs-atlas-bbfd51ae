---
title: "Get started with Porfolio & Blog CMS"
sidebarTitle: "Quickstart"
description: "Clone the repository, apply EF Core migrations, and run the Blazor Server application locally in under five minutes."
---
...
If you prefer to use the local tool manifest already included in the repository (`.config/dotnet-tools.json`), run `dotnet tool restore` after cloning instead.
